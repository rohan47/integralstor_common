...
def get_clamav_config_path():
  ...
  try :
    ...
    return None, 'Error getting clamav configuration directory : %s'%str(e)
  else :
    return ret, None
...
def get_clamav_log_folder_path():
  ...
  try:
    ...
    return None, 'Error getting clamav logs directory : %s'%str(e)
  else:
    return ret, None
"""
...
def get_clamav_quarantine_path():
  ...
  try :
    ...
    return None, 'Error getting clamav quarantine directory : %s'%str(e)
  else :
    return ret, None
"""
...
def clamav_virus_definations_directory():
  ...
  try :
    ...
    return None, 'Error getting clamav virus definations directory : %s'%str(e)
  else :
    return ret, None
